...
function setup() {
	...
	block17 = new Block(975, 400);
	block18 = new Block(1005, 400);
	block19 = new Block(1035, 400);

	block20 = new Block(990, 300);
	block21 = new Block(1020, 300);

	block22 = new Block(1005, 200);
